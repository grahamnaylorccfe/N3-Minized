...
HD_PWD='E:/MINIZED_N3Z/minized_petalinux.runs/minized_petalinux_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minized_petalinux_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minized_petalinux_util_vector_logic_0_0.tcl
