...
create_clock -name clk_fpga_2 -period "6.25" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 0.1875
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_1 -period "20.625" [get_pins "PS7_i/FCLKCLK[1]"]
set_input_jitter clk_fpga_1 0.61875
#The clocks are asynchronous, user should constrain them appropriately.#
